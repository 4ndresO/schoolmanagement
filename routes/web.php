...
use App\Http\Controllers\Backend\Parent\ParentRegController;
use App\Http\Controllers\Backend\Parent\ParentStudentController;
...
Route::prefix('parent')->group(function(){
    ...
    Route::get('reg/parent/view',[ParentRegController::class, 'ParentRegView'])->name('parent.registration.view');
